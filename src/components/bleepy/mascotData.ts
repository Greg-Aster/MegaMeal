...
export interface CuppyCakeSurrealAnimation extends BaseAnimation {
  pupilSelector: string;
  eyeGroupSelector: string;
  duration: number;
}
...
export type SurrealAnimationData = CuppyCakeSurrealAnimation | PretzelPeteSurrealAnimation | SushiSamSurrealAnimation;
