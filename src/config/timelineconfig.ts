...
export const starTypes: string[] = ['point', 'classic', 'sparkle', 'refraction', 'halo', 'subtle'];

// Constellation configuration for star positioning
export const constellationConfig: Record<string, {
  ...
  'cosmic-origin': { centerAzimuth: 30, centerElevation: 70, spread: 25, pattern: 'scattered' },
  // New eras from content
  'wip': { centerAzimuth: 90, centerElevation: 45, spread: 30, pattern: 'scattered' },
  'the-dark-between': { centerAzimuth: 210, centerElevation: 35, spread: 35, pattern: 'scattered' },
  'preservation-era': { centerAzimuth: 270, centerElevation: 50, spread: 40, pattern: 'crown' },
...
export const constellationPatterns: Record<string, Array<{azOffset: number; elOffset: number}>> = {
  ancient_wisdom: [
...
export const connectionPatterns: Record<string, Array<[number, number]>> = {
  ...
  crossed_swords: [[0,1], [2,3], [0,4], [1,4], [2,4], [3,4]],
