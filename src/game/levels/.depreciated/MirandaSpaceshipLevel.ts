...
export class MirandaSpaceshipLevel extends BaseLevel {
  ...
  private readonly levelConfig = {
    ...
    description:
      'Bridge of salvage vessel "Second Breakfast" - investigating the Miranda incident',
    ...
    ship_layout: {
      walls: [
        ...
        {
          type: 'WallAstra_Corner_Square_Outer',
          position: [8, 0, -10],
          rotation: [0, 0, 0],
        },
        {
