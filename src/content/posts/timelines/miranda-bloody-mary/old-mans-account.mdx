...
<div className="card-base p-6 mb-6">
  ...
  <p className="text-lg text-gray-700 dark:text-neutral-300 mb-4">The following account is an AI simulation based on crew testimonies and dreams experienced after exposure to the Miranda debris field radiation. The subject, referred to as "Old Man 1" or "Fruzzy," has been reconstructed from the collective unconscious experiences of the "Second Breakfast" crew. This reconstruction displays significant temporal displacement characteristics consistent with exposure to a temporal anomaly. The simulation mixes fragmented memories from the apparent time loop created in the Bibimbap Saloon with perceptions of the destruction of the Miranda system.</p>
...
<div className="font-jetbrains-mono pl-10 pr-10 py-10 rounded-xl bg-[oklch(0.95_0.025_var(--hue))] dark:bg-[oklch(0.25_0.025_var(--hue))] transition shadow-lg mb-8 overflow-hidden relative">
  ...
  <blockquote className="mt-4 text-xl text-[oklch(0.35_0.05_var(--hue))] dark:text-[oklch(0.85_0.05_var(--hue))]">
    ...
    One loop, I remember that number exactly—the robot bartender went haywire and started shooting at the jukebox. Another loop, the windows showed the actual Miranda skyline like we were really there, and we could see the sky changing color as the star went supernova. 
...
<div className="card-base p-6 mb-6">
  ...
  <p className="text-lg text-gray-700 dark:text-neutral-300 mb-4">As the doors to the Bibimbap Saloon swung open for what seemed to be the final time, the simulation shows him freezing mid-sentence, his eyes widening in what appeared to be recognition. "Well, I'll be damned," he whispers. "She's really here. And it's the final loop—just like I predicted."</p>
