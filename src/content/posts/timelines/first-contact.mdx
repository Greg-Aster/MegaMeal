  ...
  <div className="card-base2 p-6">
    ...
    <div className="space-y-4">
      <div className="flex items-center justify-between">
        <span className="text-gray-300">Successful Contact:</span>
    ...
    <p className="text-xs text-gray-400 mt-4 italic">
      *"Everything Else" includes but is not limited to: vaporization, mutation, jello-fication, existential erasure, and being converted into decorative wall art.
    </p>
  </div>
  ...
  <div className="card-base2 p-6">
    ...
    <div className="space-y-3">
      <div className="flex items-center gap-3">
        ...
        <span className="text-sm text-gray-300">Hostile Biologics</span>
        <span className="text-red-400 text-xs ml-auto">47.3%</span>
      </div>
      <div className="flex items-center gap-3">
        <div className="w-3 h-3 bg-orange-500 rounded-full"></div>
        <span className="text-sm text-gray-300">Incompatible Physics</span>
        <span className="text-orange-400 text-xs ml-auto">31.8%</span>
      </div>
      <div className="flex items-center gap-3">
        <div className="w-3 h-3 bg-yellow-500 rounded-full"></div>
        <span className="text-sm text-gray-300">Cosmic Indifference</span>
        <span className="text-yellow-400 text-xs ml-auto">15.2%</span>
      </div>
      <div className="flex items-center gap-3">
        <div className="w-3 h-3 bg-purple-500 rounded-full"></div>
        <span className="text-sm text-gray-300">Pure Malevolence</span>
        <span className="text-purple-400 text-xs ml-auto">5.7%</span>
      </div>
    </div>
  </div>
</div>
...
<div className="font-jetbrains-mono bg-gray-900/80 border-2 border-gray-500/50 rounded-lg p-6 mb-8">
  ...
  <div className="bg-red-900/30 border border-red-500/50 rounded p-4">
    <p className="text-red-200 text-sm leading-relaxed">
      <strong>Translation:</strong> Monitor their emissions in a black box scenario from light-years away, with a contingency plan and backups upon backups upon backups.[1, 1] Is that clear? Good. Because the universe doesn't offer second chances, only object lessons in humility, usually delivered at relativistic speeds.
    </p>
  </div>
</div>
...
<div className="bg-yellow-900/20 border border-yellow-500/40 rounded-lg p-6 mb-8">
  <div className="flex items-start gap-4">
    <span className="w-8 h-8 bg-yellow-500 rounded-lg flex items-center justify-center text-black text-lg font-bold">⚠</span>
    <div>
      <h4 className="text-yellow-400 font-bold text-lg mb-2">Bureaucratic Reality Check</h4>
      <p className="text-yellow-200 leading-relaxed">
        Absurd, isn't it? The only truly sane, and indeed survivable, part of this labyrinthine directive is its oft-ignored summary: <strong>monitor their emissions in a black box scenario from light-years away, with a contingency plan and backups upon backups upon backups</strong>.[1, 1] The overwhelming emphasis on "DON'T" and the byzantine nature of official protocols stem from a deeper understanding of the multifaceted nature of existential threats.
      </p>
    </div>
  </div>
</div>
...
<div className="bg-gradient-to-r from-blue-900/40 to-cyan-900/20 rounded-xl p-6 mb-8">
  <h4 className="text-cyan-400 font-bold text-xl mb-6 flex items-center gap-3">
    <span className="w-8 h-8 bg-cyan-500/20 rounded-lg flex items-center justify-center">🌡️</span>
    Extremophile Threat Assessment Matrix
  </h4>
  ...
  <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
    <div className="space-y-4">
      <div className="bg-red-900/40 border border-red-500/40 rounded-lg p-4">
        ...
        <p className="text-red-200 text-sm mb-2">Thriving at >80°C</p>
        <p className="text-gray-300 text-xs leading-relaxed">
          These creatures don't just tolerate heat; they revel in it. Their specialized thermozymes could happily colonize your ship's reactor core, viewing it as a cozy geothermal spa. Imagine an alien pathogen that finds your internal body temperature quaintly lukewarm.
        </p>
      </div>
      
      <div className="bg-blue-900/40 border border-blue-500/40 rounded-lg p-4">
        <h5 className="text-blue-400 font-bold mb-2 flex items-center gap-2">
          <span className="w-4 h-4 bg-blue-500 rounded"></span>
          Psychrophiles
        </h5>
        <p className="text-blue-200 text-sm mb-2">Flourishing below 15°C</p>
        <p className="text-gray-300 text-xs leading-relaxed">
          A journey through the icy voids of interstellar space is just a Tuesday for them. They might not spread quickly, but their insidious, creeping nature could make them a slow, frozen doom.
        </p>
      </div>
      
      <div className="bg-yellow-900/40 border border-yellow-500/40 rounded-lg p-4">
        <h5 className="text-yellow-400 font-bold mb-2 flex items-center gap-2">
          <span className="w-4 h-4 bg-yellow-500 rounded"></span>
          Halophiles
        </h5>
        <p className="text-yellow-200 text-sm mb-2">High-salt environment masters</p>
        <p className="text-gray-300 text-xs leading-relaxed">
          Their ability to maintain osmotic balance in hypersaline conditions suggests a robustness against many conventional chemical disruption methods. Your attempts to "salt" them out might just be seasoning.
        </p>
      </div>
    </div>
    ...
    <div className="space-y-4">
      <div className="bg-purple-900/40 border border-purple-500/40 rounded-lg p-4">
        ...
        <p className="text-purple-200 text-sm mb-2">Extreme pH survivors</p>
        <p className="text-gray-300 text-xs leading-relaxed">
          These organisms thrive in pH levels that would dissolve your ship's hull, let alone your delicate tissues. Their internal pH regulation makes them impervious to chemical attacks that would turn most life into a bubbling slurry.
        </p>
      </div>
      ...
      <div className="bg-green-900/40 border border-green-500/40 rounded-lg p-4">
        ...
        <p className="text-green-200 text-sm mb-2">Radiation-resistant champions</p>
        <p className="text-gray-300 text-xs leading-relaxed">
          Perhaps most unsettling for the unprepared space traveler, these organisms can withstand doses of ionizing radiation thousands of times greater than what would be lethal for humans. The radiation bath from a nearby pulsar might be nothing more than a pleasant tingle.
        </p>
      </div>
      
      <div className="bg-gray-800 border-2 border-red-500 rounded-lg p-4">
        <h5 className="text-red-400 font-bold mb-2 flex items-center gap-2">
          <span className="w-4 h-4 bg-red-500 rounded animate-pulse"></span>
          Polyextremophiles
        </h5>
        <p className="text-red-200 text-sm mb-2 font-bold">THE TRUE NIGHTMARES</p>
        <p className="text-gray-300 text-xs leading-relaxed">
          Adapted to multiple extreme stressors simultaneously. Imagine a creature that enjoys bathing in concentrated acid at near-boiling temperatures while shrugging off hard vacuum and a lethal dose of gamma rays for breakfast. This isn't just surviving; they are <em>thriving</em> in conditions that would render your atoms into a disorganized cloud.
        </p>
      </div>
    </div>
  </div>
...
<div className="bg-gradient-to-r from-red-900/50 to-orange-900/30 border-2 border-red-500 rounded-xl p-8 mb-8">
  <h4 className="text-red-400 font-bold text-2xl mb-6 flex items-center gap-3">
    ...
    CASE STUDIES: DOCUMENTED FAILURES
  </h4>
...
<div className="grid grid-cols-1 lg:grid-cols-2 gap-8 mb-8">
  <div className="card-base p-6 border-l-4 border-red-500">
    <div className="flex items-center gap-3 mb-4">
      ...
      <h5 className="text-red-400 font-bold text-lg">Case Study Alpha</h5>
    </div>
    <h6 className="text-xl font-bold text-red-300 mb-4">The Viral Voicemail</h6>
    <div className="space-y-4">
      <div className="bg-red-900/20 p-4 rounded border border-red-500/30">
        <h6 className="text-red-400 font-bold text-sm mb-2">Incident Overview</h6>
        <p className="text-red-200 text-sm leading-relaxed">
          An exploratory drone investigating an anomalous signal returned with more than telemetry—it transmitted a viral payload. Not "going viral" in the sense of becoming a popular sensation on SpaceTube, but <em>actually</em> viral, in the biological sense.[1]
        </p>
      </div>
      
      <div className="bg-orange-900/20 p-4 rounded border border-orange-500/30">
        <h6 className="text-orange-400 font-bold text-sm mb-2">Scientific Analysis</h6>
        <p className="text-orange-200 text-sm leading-relaxed">
          Extraterrestrial viruses, products of a "second genesis" on an alien world, could be hyper-virulent to terrestrial life due to a complete lack of co-evolutionary history. Our immune systems simply wouldn't recognize the threat until cellular integrity was a fond memory.
        </p>
      </div>
      
      <div className="bg-yellow-900/20 p-4 rounded border border-yellow-500/30">
        <h6 className="text-yellow-400 font-bold text-sm mb-2">Outcome Assessment</h6>
        <p className="text-yellow-200 text-sm leading-relaxed">
          The drone's transmission wasn't just data; it was a death sentence, delivered digitally. Many viruses exhibit remarkable resilience, maintaining infectivity even under the harsh conditions of space—radiation, vacuum, extreme temperatures.
        </p>
      </div>
    </div>
  </div>
  ...
  <div className="card-base p-6 border-l-4 border-purple-500">
    <div className="flex items-center gap-3 mb-4">
      <span className="w-8 h-8 bg-purple-500/20 rounded-lg flex items-center justify-center text-purple-400">⚛️</span>
      <h5 className="text-purple-400 font-bold text-lg">Case Study Beta</h5>
    </div>
    <h6 className="text-xl font-bold text-purple-300 mb-4">The Enigma of Grimace 581c</h6>
    <div className="space-y-4">
      <div className="bg-purple-900/20 p-4 rounded border border-purple-500/30">
        <h6 className="text-purple-400 font-bold text-sm mb-2">Entity Classification</h6>
        <p className="text-purple-200 text-sm leading-relaxed">
          Named after the sole, expletive-laden coherent phrase recovered from the final transmission of the starship <em>Icarus's Folly</em>. Represents a threat of an entirely different order.
        </p>
      </div>
      
      <div className="bg-blue-900/20 p-4 rounded border border-blue-500/30">
        <h6 className="text-blue-400 font-bold text-sm mb-2">Containment Failure</h6>
        <p className="text-blue-200 text-sm leading-relaxed">
          Initial containment near a black hole event horizon proved "optimistic to the point of suicidal naivety." Grimace 581c escaped by "using vibrations on the subatomic Planck scale to recreate complex mathematical gateways."
        </p>
      </div>
      
      <div className="bg-red-900/20 p-4 rounded border border-red-500/30">
        <h6 className="text-red-400 font-bold text-sm mb-2">Threat Level: MAXIMUM</h6>
        <p className="text-red-200 text-sm leading-relaxed">
          An entity that can manipulate the Planck scale can, in essence, rewrite the source code of reality. Containment becomes a philosophical absurdity. The "black box scenario," our ultimate safeguard, is rendered utterly impotent.
        </p>
      </div>
    </div>
  </div>
...
<div className="bg-gradient-to-br from-gray-900/60 to-red-900/30 border border-gray-500/50 rounded-xl p-6 mb-8">
...
<div className="grid grid-cols-1 lg:grid-cols-2 gap-6 mb-8">
  <div className="card-base2 p-6">
    <h5 className="text-red-400 font-bold text-lg mb-4 flex items-center gap-2">
      ...
      Microscopic & Sub-Atomic Annihilators
    </h5>
    <div className="bg-red-900/20 border border-red-500/30 rounded p-4 mb-4">
      <p className="text-red-200 text-sm font-bold mb-2">Warning: Not Your Grandma's Germs</p>
      <p className="text-red-100 text-sm leading-relaxed">
        The adage "don't underestimate the small stuff" [1] is perhaps the most critical piece of advice for interstellar survival. While macroscopic predators are visually impressive, it's often the unseen that proves most lethal.
      </p>
    </div>
    
    <div className="space-y-3">
      <div className="bg-orange-900/30 p-3 rounded border-l-2 border-orange-500">
        <h6 className="text-orange-400 font-bold text-sm">Alien Microbes</h6>
        <p className="text-orange-200 text-xs">
          An alien entity can be a passive vector for microscopic pathogens of unimaginable virulence. Entire star systems have been extinguished by such insidious invasions.
        </p>
      </div>
      
      <div className="bg-purple-900/30 p-3 rounded border-l-2 border-purple-500">
        <h6 className="text-purple-400 font-bold text-sm">Grey Goo Scenarios</h6>
        <p className="text-purple-200 text-xs">
          Self-replicating nanomachines programmed to consume all biomass, converting it into more of themselves. The "swarms" could encompass such nanite plagues.
        </p>
      </div>
      
      <div className="bg-blue-900/30 p-3 rounded border-l-2 border-blue-500">
        <h6 className="text-blue-400 font-bold text-sm">Environmental Toxins</h6>
        <p className="text-blue-200 text-xs">
          Alien microbes might alter your environment to be lethal, perhaps by excreting byproducts that are fantastically toxic to your particular brand of biology.
        </p>
      </div>
    </div>
  </div>
  ...
  <div className="card-base2 p-6">
    <h5 className="text-blue-400 font-bold text-lg mb-4 flex items-center gap-2">
      ...
      Macroscopic Malevolence
    </h5>
    <div className="bg-blue-900/20 border border-blue-500/30 rounded p-4 mb-4">
      <p className="text-blue-200 text-sm font-bold mb-2">It's Not Always Personal, But It's Usually Fatal</p>
      <p className="text-blue-100 text-sm leading-relaxed">
        On the macroscopic scale, an alien entity can, of course, be purely hostile. However, even "malevolence" is an anthropocentric interpretation.
      </p>
    </div>
    
    <div className="space-y-3">
      <div className="bg-yellow-900/30 p-3 rounded border-l-2 border-yellow-500">
        <h6 className="text-yellow-400 font-bold text-sm">Resource Competition</h6>
        <p className="text-yellow-200 text-xs">
          The Dark Forest theory: survival and resource expansion make preemptive annihilation of potential competitors a grimly logical strategy.
        </p>
      </div>
      
      <div className="bg-green-900/30 p-3 rounded border-l-2 border-green-500">
        <h6 className="text-green-400 font-bold text-sm">Cosmic Insignificance</h6>
        <p className="text-green-200 text-xs">
          Their routine stellar engineering projects could inadvertently obliterate entire solar systems as collateral damage, without a flicker of malice or awareness.
        </p>
      </div>
      
      <div className="bg-red-900/30 p-3 rounded border-l-2 border-red-500">
        <h6 className="text-red-400 font-bold text-sm">Alien Logic Systems</h6>
        <p className="text-red-200 text-xs">
          A hive mind, rogue AI, or civilization driven by incomprehensible religious dogma might pursue objectives that are purely destructive from our perspective.
        </p>
      </div>
    </div>
  </div>
  ...
  <div className="relative z-10 mt-8">
    ...
    <div className="space-y-4 text-red-200">
      ...
      <p className="text-lg font-bold text-yellow-400">
        THANK YOU FOR YOUR TIME. PLEASE SHOP SMART. S-MART. YOU GOT THAT?
      </p>
    ...
    <div className="card-base p-6 border-l-4 border-yellow-500">
      ...
      <div className="space-y-3">
        <p className="text-gray-300 text-sm leading-relaxed">
          "PLEASE SHOP SMART. S-MART. YOU GOT THAT?" - This is where the protocol transcends mere desperation and veers into the realm of bleak corporate satire. S-Mart has somehow managed to embed its branding into the very fabric of emergency communications.
        </p>
...
<div className="grid grid-cols-1 lg:grid-cols-2 gap-8 mb-8">
  ...
  <div className="card-base p-6 border-l-4 border-red-500">
    ...
    <div className="space-y-2">
      ...
      <div className="bg-red-900/30 p-2 rounded">
        <p className="text-red-200 text-xs">• Designate beneficiary for S-Mart loyalty points</p>
      </div>
      <div className="bg-red-900/30 p-2 rounded">
...
<div className="bg-gradient-to-br from-red-900/60 to-black/40 border-4 border-red-500 rounded-xl p-8 mb-8 text-center">
  ...
  <div className="bg-yellow-900/30 border border-yellow-500/50 rounded-lg p-6">
    ...
    <h4 className="text-3xl font-bold text-yellow-300">S-MART</h4>
...
Please shop smart. S-Mart. You got that?
