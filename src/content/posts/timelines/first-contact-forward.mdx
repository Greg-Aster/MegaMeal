...
<div className="relative bg-gradient-to-br from-red-900/30 via-black/40 to-red-800/20 border-2 border-red-500/50 rounded-xl p-8 mb-8 overflow-hidden">
  ...
  <div className="absolute bottom-0 left-0 w-32 h-32 bg-red-600/15 rounded-full blur-2xl animate-pulse delay-1000"></div>
  <div className="absolute top-1/2 left-1/2 w-24 h-24 bg-orange-500/10 rounded-full blur-xl animate-bounce delay-500"></div>
  
  {/* Geometric overlay patterns */}
  <div className="absolute inset-0 opacity-5">
    <div className="absolute top-4 left-4 w-2 h-2 bg-red-400 rotate-45"></div>
    <div className="absolute top-8 right-8 w-3 h-3 bg-orange-400 rotate-12"></div>
    <div className="absolute bottom-6 left-8 w-2 h-2 bg-yellow-400 rotate-45"></div>
    <div className="absolute bottom-12 right-12 w-4 h-4 bg-red-400 rotate-12"></div>
  </div>
  
  <div className="relative z-10">
    <div className="flex items-center gap-4 mb-6">
      <div className="relative">
        <div className="w-12 h-12 bg-gradient-to-br from-red-500 to-red-600 rounded-lg flex items-center justify-center shadow-lg shadow-red-500/30">
          <span className="text-white font-bold text-xl drop-shadow-lg">⚠</span>
        </div>
        <div className="absolute -inset-1 bg-gradient-to-br from-red-400/50 to-red-600/50 rounded-lg blur opacity-70 animate-pulse"></div>
      </div>
      <div className="flex-1">
        <span className="font-jetbrains-mono text-red-400 text-sm tracking-wider uppercase font-bold">Classified - Eyes Only</span>
        <div className="w-20 h-0.5 bg-gradient-to-r from-red-500 to-transparent mt-1"></div>
      </div>
    </div>
    
    <div className="grid grid-cols-1 lg:grid-cols-3 gap-6 mb-8">
      <div className="relative group">
        <div className="absolute inset-0 bg-gradient-to-br from-red-600/20 to-red-800/10 rounded-lg blur opacity-50 group-hover:opacity-70 transition-opacity"></div>
        <div className="relative bg-black/40 backdrop-blur-sm p-5 rounded-lg border border-red-500/30 hover:border-red-400/50 transition-all">
          <div className="space-y-3 font-jetbrains-mono text-sm">
            <div className="flex justify-between items-center">
              <span className="text-gray-400">Security Level:</span>
              <span className="text-red-400 font-bold bg-red-900/30 px-2 py-1 rounded">COSMIC HORROR</span>
            </div>
            <div className="flex justify-between items-center">
              <span className="text-gray-400">Distribution:</span>
              <span className="text-orange-400 font-bold bg-orange-900/30 px-2 py-1 rounded">Survivors Only</span>
            </div>
          </div>
        </div>
      </div>
      ...
      <div className="relative group">
        ...
        <div className="relative bg-black/40 backdrop-blur-sm p-5 rounded-lg border border-orange-500/30 hover:border-orange-400/50 transition-all">
          <div className="space-y-3 font-jetbrains-mono text-sm">
            <div className="flex justify-between items-center">
              <span className="text-gray-400">Author Status:</span>
              <span className="text-gray-300 bg-gray-800/50 px-2 py-1 rounded">[REDACTED]</span>
            </div>
            <div className="flex justify-between items-center">
              <span className="text-gray-400">Mortality Rate:</span>
              <span className="text-red-500 font-bold bg-red-900/40 px-2 py-1 rounded">99.997%</span>
            </div>
          </div>
        </div>
      </div>
      ...
      <div className="relative group">
        <div className="absolute inset-0 bg-gradient-to-br from-yellow-600/20 to-yellow-800/10 rounded-lg blur opacity-50 group-hover:opacity-70 transition-opacity"></div>
        <div className="relative bg-black/40 backdrop-blur-sm p-5 rounded-lg border border-yellow-500/30 hover:border-yellow-400/50 transition-all">
          <div className="space-y-3 font-jetbrains-mono text-sm">
            <div className="flex justify-between items-center">
              <span className="text-gray-400">Threat Entries:</span>
              <span className="text-yellow-400 font-bold bg-yellow-900/30 px-2 py-1 rounded">47,829</span>
            </div>
            <div className="flex justify-between items-center">
              <span className="text-gray-400">Galactic Sectors:</span>
              <span className="text-blue-400 font-bold bg-blue-900/30 px-2 py-1 rounded">12</span>
            </div>
          </div>
        </div>
      </div>
    ...
    <div className="relative">
      ...
      <blockquote className="relative text-red-200 text-xl italic font-medium leading-relaxed text-center py-6 px-4">
        <span className="text-red-400 text-6xl leading-none">"</span>
      ...
      <div className="text-center mt-4">
        <cite className="text-red-300 text-sm font-jetbrains-mono">- Hand Guide for Interstellar Travel and Objects of Unknown Origin, p. 37</cite>
      </div>
    </div>
  </div>
</div>
...
<div className="grid grid-cols-3 gap-8 mb-8">
  {/* Left 2/3 - Manual Navigation */}
  <div className="col-span-2">
    <div className="relative bg-gradient-to-br from-yellow-900/30 via-amber-900/20 to-yellow-800/30 border-l-4 border-yellow-500 rounded-r-lg p-6 overflow-hidden h-full">
      ...
      <div className="relative z-10">
        ...
        <div className="space-y-3 text-yellow-200 leading-relaxed">
          <p>
  ...
  {/* Right 1/3 - Classification Window */}
  <div className="col-span-1">
    <div className="relative bg-gradient-to-br from-red-900/30 via-black/40 to-red-800/20 border-2 border-red-500/50 rounded-xl p-6 overflow-hidden h-full">
      {/* Floating orbs and ambient effects */}
      <div className="absolute top-0 right-0 w-32 h-32 bg-red-500/20 rounded-full blur-3xl animate-pulse"></div>
      <div className="absolute bottom-0 left-0 w-24 h-24 bg-red-600/15 rounded-full blur-2xl animate-pulse delay-1000"></div>
      <div className="absolute top-1/2 left-1/2 w-16 h-16 bg-orange-500/10 rounded-full blur-xl animate-bounce delay-500"></div>
      
      {/* Geometric overlay patterns */}
      <div className="absolute inset-0 opacity-5">
        <div className="absolute top-2 left-2 w-1 h-1 bg-red-400 rotate-45"></div>
        <div className="absolute top-4 right-4 w-2 h-2 bg-orange-400 rotate-12"></div>
        <div className="absolute bottom-3 left-4 w-1 h-1 bg-yellow-400 rotate-45"></div>
        <div className="absolute bottom-6 right-6 w-2 h-2 bg-red-400 rotate-12"></div>
      </div>
      ...
      <div className="relative z-10">
        <div className="flex items-center gap-3 mb-4">
          ...
          <div className="flex-1">
            <span className="font-jetbrains-mono text-red-400 text-xs tracking-wider uppercase font-bold">Classified</span>
            <div className="w-12 h-0.5 bg-gradient-to-r from-red-500 to-transparent mt-1"></div>
          </div>
        </div>
        ...
        <div className="space-y-3 mb-6">
          <div className="relative group">
            <div className="absolute inset-0 bg-gradient-to-br from-red-600/20 to-red-800/10 rounded-lg blur opacity-50 group-hover:opacity-70 transition-opacity"></div>
            <div className="relative bg-black/40 backdrop-blur-sm p-3 rounded-lg border border-red-500/30 hover:border-red-400/50 transition-all">
              <div className="space-y-2 font-jetbrains-mono text-xs">
                <div className="flex justify-between items-center">
                  <span className="text-gray-400">Security Level:</span>
                  <span className="text-red-400 font-bold bg-red-900/30 px-2 py-1 rounded text-xs">COSMIC HORROR</span>
                </div>
                <div className="flex justify-between items-center">
                  <span className="text-gray-400">Distribution:</span>
                  <span className="text-orange-400 font-bold bg-orange-900/30 px-2 py-1 rounded text-xs">Survivors Only</span>
                </div>
              </div>
            </div>
          </div>
          ...
          <div className="relative group">
            <div className="absolute inset-0 bg-gradient-to-br from-orange-600/20 to-orange-800/10 rounded-lg blur opacity-50 group-hover:opacity-70 transition-opacity"></div>
            <div className="relative bg-black/40 backdrop-blur-sm p-3 rounded-lg border border-orange-500/30 hover:border-orange-400/50 transition-all">
              <div className="space-y-2 font-jetbrains-mono text-xs">
                <div className="flex justify-between items-center">
                  <span className="text-gray-400">Author Status:</span>
                  <span className="text-gray-300 bg-gray-800/50 px-2 py-1 rounded text-xs">[REDACTED]</span>
                </div>
                <div className="flex justify-between items-center">
                  <span className="text-gray-400">Mortality Rate:</span>
                  <span className="text-red-500 font-bold bg-red-900/40 px-2 py-1 rounded text-xs">99.997%</span>
                </div>
              </div>
            </div>
          </div>
          ...
          <div className="relative group">
            <div className="absolute inset-0 bg-gradient-to-br from-yellow-600/20 to-yellow-800/10 rounded-lg blur opacity-50 group-hover:opacity-70 transition-opacity"></div>
            <div className="relative bg-black/40 backdrop-blur-sm p-3 rounded-lg border border-yellow-500/30 hover:border-yellow-400/50 transition-all">
              <div className="space-y-2 font-jetbrains-mono text-xs">
                <div className="flex justify-between items-center">
                  <span className="text-gray-400">Threat Entries:</span>
                  <span className="text-yellow-400 font-bold bg-yellow-900/30 px-2 py-1 rounded text-xs">47,829</span>
                </div>
                <div className="flex justify-between items-center">
                  <span className="text-gray-400">Galactic Sectors:</span>
                  <span className="text-blue-400 font-bold bg-blue-900/30 px-2 py-1 rounded text-xs">12</span>
                </div>
              </div>
            </div>
          </div>
        ...
        <div className="relative">
          <div className="absolute inset-0 bg-gradient-to-r from-red-500/10 via-transparent to-red-500/10 rounded-lg"></div>
          <blockquote className="relative text-red-200 text-sm italic font-medium leading-relaxed text-center py-3 px-2">
            <span className="text-red-400 text-2xl leading-none">"</span>
            <span className="text-xs">The cosmos is a vast, indifferent horror show, and you, dear traveler, have just bought a front-row ticket with a complimentary side of existential dread.</span>
            <span className="text-red-400 text-2xl leading-none">"</span>
          </blockquote>
          <div className="text-center mt-2">
            <cite className="text-red-300 text-xs font-jetbrains-mono">- Hand Guide, p. 37</cite>
          </div>
        </div>
      </div>
    </div>
...
<div className="text-center mb-12">
  <h2 className="text-4xl font-bold bg-gradient-to-r from-blue-400 via-purple-500 to-blue-600 bg-clip-text text-transparent mb-4">
    Chapter Navigation & Threat Assessment Guide
  </h2>
  <div className="w-32 h-1 bg-gradient-to-r from-blue-500 to-purple-500 mx-auto rounded-full"></div>
</div>

<div className="relative bg-gradient-to-br from-blue-900/40 via-purple-900/30 to-black/20 border border-blue-500/50 rounded-xl p-8 mb-12 overflow-hidden">
  ...
  <div className="relative z-10">
    <div className="flex items-center gap-4 mb-6">
      <div className="relative">
        ...
        <div className="absolute -inset-1 bg-gradient-to-br from-blue-400/50 to-purple-600/50 rounded-xl blur opacity-70"></div>
      </div>
      <h3 className="text-blue-400 font-bold text-2xl bg-gradient-to-r from-blue-400 to-purple-400 bg-clip-text text-transparent">
...
<div className="mb-12">
  <div className="flex items-center gap-3 mb-6">
    ...
    <h4 className="text-xl font-bold text-blue-400">Essential Reading</h4>
        ...
        <div className="flex items-center gap-6 mb-6">
          ...
          <div className="flex-1">
            <h3 className="text-blue-300 font-bold text-2xl leading-tight mb-2 group-hover:text-blue-200 transition-colors">
              The Interstellar Traveler's Admonition
            </h3>
...
<div className="mb-12">
  <div className="flex items-center gap-3 mb-6">
    <div className="w-8 h-8 bg-gradient-to-br from-purple-500 to-red-600 rounded-lg flex items-center justify-center shadow-lg">
      <span className="text-white font-bold text-sm">👾</span>
    </div>
    <h4 className="text-xl font-bold text-purple-400">Xenobiological Classifications</h4>
...
<div className="mb-12">
  <div className="flex items-center gap-3 mb-6">
    <div className="w-8 h-8 bg-gradient-to-br from-blue-500 to-red-600 rounded-lg flex items-center justify-center shadow-lg">
      <span className="text-white font-bold text-sm">⚔️</span>
    </div>
    <h4 className="text-xl font-bold text-blue-400">Threat Assessment Matrix</h4>
      ...
      <div className="relative bg-gradient-to-br from-blue-900/50 via-cyan-900/30 to-black/40 border-2 border-blue-500/40 group-hover:border-blue-400/80 rounded-xl p-8 backdrop-blur-sm overflow-hidden transition-all duration-500">
        ...
        <div className="relative z-10">
          <div className="flex items-center gap-6 mb-6">
            ...
            <div className="flex-1">
              <h3 className="text-blue-300 font-bold text-2xl leading-tight mb-2 group-hover:text-blue-200 transition-colors">
                The Complete Guide to First Contact Catastrophes
              </h3>
          ...
          <div className="flex items-center gap-6 mb-6">
            ...
            <div className="flex-1">
              <h3 className="text-red-300 font-bold text-2xl leading-tight mb-2 group-hover:text-red-200 transition-colors">
                When They Actually Want You Dead
              </h3>
...
<div className="mb-12">
  <div className="flex items-center gap-3 mb-6">
    <div className="w-8 h-8 bg-gradient-to-br from-gray-500 to-red-600 rounded-lg flex items-center justify-center shadow-lg">
      <span className="text-white font-bold text-sm">🚨</span>
    </div>
    <h4 className="text-xl font-bold text-gray-400">Crisis Management</h4>
        ...
        <div className="flex items-center gap-6 mb-6">
          ...
          <div className="flex-1">
            <h3 className="text-gray-300 font-bold text-2xl leading-tight mb-2 group-hover:text-gray-200 transition-colors">
              The "All Hope is Lost, You Fool" Protocol
            </h3>
...
<div className="mb-12">
  <div className="flex items-center gap-3 mb-6">
    <div className="w-8 h-8 bg-gradient-to-br from-purple-500 to-black rounded-lg flex items-center justify-center shadow-lg">
      <span className="text-white font-bold text-sm">🌌</span>
    </div>
    <h4 className="text-xl font-bold text-purple-400">Final Analysis</h4>
    <div className="flex-1 h-0.5 bg-gradient-to-r from-purple-500/50 to-transparent"></div>
  </div>
...
<div className="relative bg-gray-900/60 border border-gray-500/50 rounded-xl p-6 mt-12 overflow-hidden">
  ...
  <div className="relative z-10">
    <h4 className="text-gray-300 font-bold text-lg mb-4 flex items-center gap-2">
      <span className="w-6 h-6 bg-gray-500/30 rounded flex items-center justify-center text-sm">📋</span>
