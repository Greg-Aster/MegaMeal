---
title: "The Galactic Cookbook: A Culinary Compendium Across Time and Space"
...
bannerData:
  ...
  startYear: 1
  endYear: 50000
  background: "/posts/timeline/cookbook-collection.png"
    ...
    <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
      <div className="space-y-4">
        ...
        <div className="flex items-center gap-4 text-sm text-gray-600 dark:text-neutral-400 mb-4">
          <span><strong>Difficulty:</strong> 🔴 Complex</span>
          <span><strong>Prep Time:</strong> ∞ loops</span>
          <span><strong>Era:</strong> Singularity Conflict</span>
        </div>
    ...
    <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
      ...
      <div className="order-1 lg:order-2 space-y-4">
        ...
        <div className="flex items-center gap-4 text-sm text-gray-600 dark:text-neutral-400 mb-4">
          ...
          <span><strong>Prep Time:</strong> 6 Std. Hours</span>
          <span><strong>Era:</strong> Golden Age</span>
        </div>
    ...
    <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
      <div className="space-y-4">
        ...
        <div className="flex items-center gap-4 text-sm text-gray-600 dark:text-neutral-400 mb-4">
          ...
          <span><strong>Prep Time:</strong> 4 Std. Hours</span>
          <span><strong>Era:</strong> Neo-Sensoria</span>
        </div>
