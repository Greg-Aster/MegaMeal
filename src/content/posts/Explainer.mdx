...
avatarImage: "/posts/timeline/merkin.png"
...
> **Interactive Layout**: Notice the layout toggle button in the top-right corner? It's now **automatically available on every post**! This post starts in single-column mode (as specified by `oneColumn: true` in the frontmatter), but readers can toggle to two-column layout anytime.
...
<div className="grid grid-cols-1 md:grid-cols-3 gap-4 mt-6 mb-6">
  ...
  >
    <div className="text-5xl mb-2">🎬</div>
    <h3 className="font-bold text-base mb-1 text-gray-800 dark:text-neutral-200 group-hover:text-[oklch(0.4_0.2_360)]">Video Explained</h3>
    <p className="text-xs text-gray-600 dark:text-neutral-400">Behind-the-scenes movie trailer</p>
  </a>
