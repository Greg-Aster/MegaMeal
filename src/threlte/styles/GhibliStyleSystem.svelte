...
<script lang="ts">
  ...
  export let ambientIntensity = 0.4
  ...
  const stylePalettes = {
    ghibli: {
      ...
      skyGradient: new THREE.Color('#FFE5B4'),
      water: new THREE.Color('#4682B4'),
      grass: new THREE.Color('#9ACD32'),
      earth: new THREE.Color('#D2B48C'),
      trees: new THREE.Color('#228B22'),
      flowers: new THREE.Color('#FF69B4'),
      fireflies: [new THREE.Color('#FFD700'), new THREE.Color('#FFAC33'), new THREE.Color('#FF6347')],
      ambient: new THREE.Color('#E6E6FA'),
      sun: new THREE.Color('#FFA500'),
      shadow: new THREE.Color('#483D8B'),
      fog: new THREE.Color('#B0C4DE'),
      outline: new THREE.Color('#2F4F4F')
    },
    alto: {
