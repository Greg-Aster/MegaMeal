...
export class Materials {
  ...
  private createToonGradientTexture(): void {
    ...
    this.toonGradientTexture = new this.THREE.DataTexture(
      data,
      size,
      size,
  ...
  public createPBRMaterial(
    ...
    if (options.displacementMap)
      materialConfig.displacementMap = options.displacementMap
  ...
  public createMetalMaterial(color = 0x888888): THREE.MeshStandardMaterial {
    return this.createPBRMaterial({
      color,
      metalness: 0.9,
      roughness: 0.1,
  ...
  public createPlasticMaterial(color = 0xffffff): THREE.MeshStandardMaterial {
    return this.createPBRMaterial({
      color,
      metalness: 0.0,
      roughness: 0.3,
  ...
  public createFabricMaterial(color = 0x444444): THREE.MeshStandardMaterial {
    return this.createPBRMaterial({
      color,
      metalness: 0.0,
      roughness: 0.8,
  ...
  public createGlassMaterial(color = 0xffffff): THREE.MeshStandardMaterial {
    return this.createPBRMaterial({
      color,
      metalness: 0.0,
      roughness: 0.1,
