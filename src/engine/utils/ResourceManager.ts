...
export class ResourceManager {
  ...
  public static disposeObject3D(obj: THREE.Object3D): void {
    ...
    console.log(`🧹 ResourceManager disposing Object3D: ${obj.type || 'Unknown'}`);
    ...
    console.log(`✅ ResourceManager disposed Object3D (Total: ${ResourceManager.disposalCount})`);
  }
  ...
  public static disposeGroup(group: THREE.Group): void {
    ...
    console.log(`🧹 ResourceManager disposing Group with ${group.children.length} children`);
  ...
  public static disposeTexture(texture: THREE.Texture): void {
    ...
    console.log(`🧹 ResourceManager disposing Texture: ${texture.name || 'Unnamed'}`);
  ...
  public static disposeScene(scene: THREE.Scene): void {
    ...
    console.log(`🧹 ResourceManager disposing Scene with ${scene.children.length} children`);
