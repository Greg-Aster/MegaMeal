...
export class PlayerLightComponent extends GameObject {
  ...
  public update(deltaTime: number): void {
    ...
    const flickerTime = this.animationTime * this.config.flickerSpeed + this.flickerOffset;
    const flickerMultiplier = 1.0 + Math.sin(flickerTime) * this.config.flickerIntensity;
