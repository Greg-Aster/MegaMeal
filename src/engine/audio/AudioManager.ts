...
export class AudioManager {
  ...
  public loadSound(id: string, src: string, options?: SoundOptions): Promise<void> {
  ...
  public fadeSound(id: string, from: number, to: number, duration: number, soundId?: number): void {
    const sound = this.sounds.get(id);
    if (sound) {
  ...
  public setSoundPosition(id: string, position: THREE.Vector3, soundId?: number): void {
  ...
  public preloadSounds(soundList: { id: string; src: string; options?: SoundOptions }[]): Promise<void[]> {
