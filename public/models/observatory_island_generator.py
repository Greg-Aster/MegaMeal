...
class ObservatoryIslandGenerator:
    ...
    def add_spawn_point_marker(self):
        ...
        spawn_mat.node_tree.nodes["Principled BSDF"].inputs[0].default_value = (1, 0, 0, 1)  # Red
        spawn_mat.node_tree.nodes["Principled BSDF"].inputs[20].default_value = 2.0  # Emission
